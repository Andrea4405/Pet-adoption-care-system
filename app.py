...
if 'pets' not in st.session_state:
    st.session_state.pets = pd.DataFrame({
        ...
        'weight': [30, 5, 32, 6],
        'color': ['Golden', 'White', 'Black', 'Cream'],
...
def add_new_pet():
    ...
    st.write("Fill out the form below to add a new pet.")  # Debugging line
    ...
    with st.form("add_pet_form"):
        ...
        if submit:
            st.success(f"Pet {name} added successfully!")  # Test if button works
    ...
    with st.form("add_pet_form", clear_on_submit=True):
        ...
        status = "Available"  # New pets are always 'Available' by default
        ...
        if submitted:
            if name and breed and image_file:
                ...
                with open(image_path, "wb") as f:
                    f.write(image_file.getbuffer())  # Save image file
...
def main():
    ...
    if page == "Home":
        ...
        pet_care_guide()
    elif page == "Add a Pet":  # ✅ Add this line
        add_new_pet()
